    ...
    messages: [
      {
        ...
        content: [
          ...
          'AI 도사식 참고 인사이트도 반드시 포함하십시오. 여기에는 지금 해야 할 행동 TOP3, 피해야 할 선택 TOP3, 올해 핵심 전략, 인생 방향 추천, 올해 위험 구간, 인간관계 충돌 시기, 금전 손실 가능성, 건강 주의 시기, 연애 시작 타이밍, 결혼 적기, 이직 타이밍, 투자 타이밍, 사업 시작 타이밍, 이동/이사 타이밍, 맞는 직업 유형 TOP3, 돈 버는 방식, 잘 맞는 인간 유형, 피해야 할 인간 유형, 좋은 방향, 좋은 지역 성향, 좋은 색상, 좋은 숫자, 좋은 이름 구조, 운을 올리는 행동, 피해야 할 습관, 운이 트이는 시기 활용법이 들어가야 합니다.',
      ...
      },
      {
        ...
        content: JSON.stringify({
          ...
          responseGuide: {
            ...
            dosa_advisory: 'AI 도사식 참고 인사이트 묶음. 타이밍/방향/색/숫자/이동/파트너/행동 조언을 긍정적이지만 과장 없이 작성',
            keywords: '짧은 핵심 키워드',
            advice: '실행 가능한 조언',
